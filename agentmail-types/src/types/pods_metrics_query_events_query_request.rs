...
pub struct PodsMetricsQueryEventsQueryRequest {
    #[serde(default)]
...
impl PodsMetricsQueryEventsQueryRequest {
    pub fn builder() -> PodsMetricsQueryEventsQueryRequestBuilder {
        <PodsMetricsQueryEventsQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PodsMetricsQueryEventsQueryRequestBuilder {
...
impl PodsMetricsQueryEventsQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`PodsMetricsQueryEventsQueryRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`event_types`](PodsMetricsQueryEventsQueryRequestBuilder::event_types)
    pub fn build(self) -> Result<PodsMetricsQueryEventsQueryRequest, BuildError> {
        Ok(PodsMetricsQueryEventsQueryRequest {
