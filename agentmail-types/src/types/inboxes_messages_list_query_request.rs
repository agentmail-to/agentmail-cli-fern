...
pub struct InboxesMessagesListQueryRequest {
...
impl InboxesMessagesListQueryRequest {
    pub fn builder() -> InboxesMessagesListQueryRequestBuilder {
        <InboxesMessagesListQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct InboxesMessagesListQueryRequestBuilder {
    limit: Option<Limit>,
...
impl InboxesMessagesListQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`InboxesMessagesListQueryRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`labels`](InboxesMessagesListQueryRequestBuilder::labels)
    pub fn build(self) -> Result<InboxesMessagesListQueryRequest, BuildError> {
        Ok(InboxesMessagesListQueryRequest {
            limit: self.limit,
