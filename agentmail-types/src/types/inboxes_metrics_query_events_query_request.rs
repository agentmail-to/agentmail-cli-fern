...
pub struct InboxesMetricsQueryEventsQueryRequest {
    #[serde(default)]
...
impl InboxesMetricsQueryEventsQueryRequest {
    pub fn builder() -> InboxesMetricsQueryEventsQueryRequestBuilder {
        <InboxesMetricsQueryEventsQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct InboxesMetricsQueryEventsQueryRequestBuilder {
...
impl InboxesMetricsQueryEventsQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`InboxesMetricsQueryEventsQueryRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`event_types`](InboxesMetricsQueryEventsQueryRequestBuilder::event_types)
    pub fn build(self) -> Result<InboxesMetricsQueryEventsQueryRequest, BuildError> {
        Ok(InboxesMetricsQueryEventsQueryRequest {
