...
pub struct CreateDraftForwardRequest {
...
impl CreateDraftForwardRequest {
    pub fn builder() -> CreateDraftForwardRequestBuilder {
        <CreateDraftForwardRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateDraftForwardRequestBuilder {
...
impl CreateDraftForwardRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateDraftForwardRequest`].
    pub fn build(self) -> Result<CreateDraftForwardRequest, BuildError> {
        Ok(CreateDraftForwardRequest {
            labels: self.labels,
