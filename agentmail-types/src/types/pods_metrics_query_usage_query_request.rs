...
pub struct PodsMetricsQueryUsageQueryRequest {
    #[serde(default)]
...
impl PodsMetricsQueryUsageQueryRequest {
    pub fn builder() -> PodsMetricsQueryUsageQueryRequestBuilder {
        <PodsMetricsQueryUsageQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PodsMetricsQueryUsageQueryRequestBuilder {
...
impl PodsMetricsQueryUsageQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`PodsMetricsQueryUsageQueryRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`usage_types`](PodsMetricsQueryUsageQueryRequestBuilder::usage_types)
    pub fn build(self) -> Result<PodsMetricsQueryUsageQueryRequest, BuildError> {
        Ok(PodsMetricsQueryUsageQueryRequest {
