...
pub struct InboxesMetricsQueryUsageQueryRequest {
    #[serde(default)]
...
impl InboxesMetricsQueryUsageQueryRequest {
    pub fn builder() -> InboxesMetricsQueryUsageQueryRequestBuilder {
        <InboxesMetricsQueryUsageQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct InboxesMetricsQueryUsageQueryRequestBuilder {
...
impl InboxesMetricsQueryUsageQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`InboxesMetricsQueryUsageQueryRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`usage_types`](InboxesMetricsQueryUsageQueryRequestBuilder::usage_types)
    pub fn build(self) -> Result<InboxesMetricsQueryUsageQueryRequest, BuildError> {
        Ok(InboxesMetricsQueryUsageQueryRequest {
