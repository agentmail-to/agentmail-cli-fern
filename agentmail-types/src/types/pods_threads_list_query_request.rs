...
pub struct PodsThreadsListQueryRequest {
...
impl PodsThreadsListQueryRequest {
    pub fn builder() -> PodsThreadsListQueryRequestBuilder {
        <PodsThreadsListQueryRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PodsThreadsListQueryRequestBuilder {
    limit: Option<Limit>,
...
impl PodsThreadsListQueryRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`PodsThreadsListQueryRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`labels`](PodsThreadsListQueryRequestBuilder::labels)
    pub fn build(self) -> Result<PodsThreadsListQueryRequest, BuildError> {
        Ok(PodsThreadsListQueryRequest {
            limit: self.limit,
